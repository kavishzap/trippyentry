...
const ActionBox = () => {
  ...
  return (
    <section className="pt-0">
      <Container>
        <div className="bg-light rounded-3 position-relative overflow-hidden p-4 p-sm-5">
            ...
            <Col xl={5}>
              <form onSubmit={handleSubmit(() => {})} className="bg-body rounded-2 p-2">
                <div className="d-flex">
                  <TextFormInput name="email" type="email" combinedInput className="border-0 me-1" placeholder="Enter your email" control={control} />
                  <button type="submit" className="btn btn-dark btn-round mb-0 flex-shrink-0 flex-centered">
