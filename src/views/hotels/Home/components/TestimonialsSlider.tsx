...
import element2 from '@/assets/images/element/02.svg'
import element3 from '@/assets/images/element/03.svg'
...
const TestimonialsSlider = () => {
  ...
  return (
    <section className="pb-0 py-md-5" id="hotels-home-testimonial">
      <Container>
        <Row>
            ...
            <div className="tiny-slider arrow-round arrow-border arrow-hover">
              <TinySlider settings={testimonialSliderSettings}>
                  ...
                  <Row className="justify-content-between align-items-center">
                    <Col md={6} lg={5} className="position-relative">
                      <div className="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
                        <img src={element2} className="h-60px bg-orange rounded p-2" />
                      </div>
                      ...
                      <img src={team1} className="rounded-3 position-relative" />
                    </Col>
                    <Col md={6} lg={6}>
                      ...
                      <ul className="list-inline small mb-2">
                        ...
                        <li className="list-inline-item">
                          <FaStarHalfStroke className="text-warning" />
                        </li>
                      </ul>
                ...
                <div className="px-4 px-md-5">
                  <Row className="justify-content-between align-items-center">
                    <Col md={6} lg={5} className="position-relative">
                      <div className="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
                        <img src={element3} className="h-60px bg-orange p-2 rounded" />
                      </div>

                      <figure className="position-absolute bottom-0 end-0 mb-n5 me-n5 d-none d-sm-block">
                        <svg width="326px" height="335px" viewBox="0 0 326 335">
                          <path
                            className="fill-primary opacity-1"
                      ...
                      <img src={team2} className="rounded-3 position-relative" />
                    </Col>
                    <Col md={6} lg={6}>
                      <span className="display-3 mb-0 text-primary">
                        <BsQuote />
