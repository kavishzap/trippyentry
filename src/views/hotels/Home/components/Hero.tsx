      ...
      <Container>
        <Row className="">
          <Col lg={6} className="position-relative mb-4 mb-md-0">
            ...
            <p className="mb-4">Ready for an unforgettable night? We bring you the hottest concerts and live shows across Mauritius — all tailored to your vibe and budget!</p>
