      ...
      <Container>
        <Row className="g-4">
          <Col lg={4} className="position-relative">
            ...
            <Image src={aboutImg9} className="rounded-3" />
            <figure className="position-absolute bottom-0 end-0 me-lg-n5 mb-n3">
              <svg className="fill-info" width="150px" height="133.5px" viewBox="0 0 150 133.5" xmlSpace="preserve">
          ...
          <Col lg={7} className="position-relative ms-auto">
            <figure className="position-absolute top-0 start-0 translate-middle mt-8 ms-n4 z-index-9 d-none d-xl-block">
              <svg className="fill-orange" width="153.6px" height="71.4px" viewBox="0 0 153.6 71.4" xmlSpace="preserve">
            ...
            <div className="position-relative mb-5">
              <Image src={aboutImg10} className="rounded-3" />
